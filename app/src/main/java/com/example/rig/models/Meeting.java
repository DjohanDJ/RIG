...
public class Meeting {
    private String id, description, link_meeting, meeting_id, meeting_password,time,created_time;
    ...
    public Meeting(String id, String description, String link_meeting, String meeting_id, String meeting_password, String time,String created_time, ArrayList<String> roles) {
        this.id = id;
