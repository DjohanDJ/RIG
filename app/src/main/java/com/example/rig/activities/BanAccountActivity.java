...
public class BanAccountActivity extends AppCompatActivity {
    ...
    private ManageUserBanAdapter userAdapter;
        ...
        SingletonFirebaseTool.getInstance().getMyFireStoreReference().collection("users").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    userAdapter = new ManageUserBanAdapter(BanAccountActivity.this, userList);
                    recyclerView.setAdapter(userAdapter);
                    recyclerView.setLayoutManager(new LinearLayoutManager(BanAccountActivity.this));
                }
            }
        });
    }
    ...
    private void doInitializeItems() {
        this.recyclerView = findViewById(R.id.recViewBanUser);
